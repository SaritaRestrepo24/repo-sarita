...
session_start();
if($_POST){
    if(($_POST['usuario']=="Sarita")&&($_POST['contraseña']="sistema")){
       
        $_SESSION['usuario']="ok";
        $_SESSION['nombreUsuario']="Sarita";
...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="css\bootstrap.min.css1.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
  </head>
  <body>
